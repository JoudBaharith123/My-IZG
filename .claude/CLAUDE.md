# Claude Agent Instructions - Binder's Business

**Company:** Binder's Business - Logistics & Distribution Intelligence  
**Last Updated:** 2025-10-29 (Auto-updated by Claude)
...
### What Claude CANNOT Do (Unless Explicitly Requested)
...
✅ **Check infrastructure details in `.Claude/infrastructure.md`**  
...
**All VM details, ports, IPs, credentials are in:** `.Claude/infrastructure.md`
...
**On EVERY edit to `universal_dev_tracker.md`, Claude MUST:**
...
- [ ] Check `.Claude/infrastructure.md` if VM/service details needed
